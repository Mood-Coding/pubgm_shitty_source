...
#define DARKERGRAY(alpha)    IM_COL32(31, 31, 31, alpha)
...
#define GREEN(alpha)         IM_COL32(0, 50, 0, alpha)
...
#define BLUE(alpha)          IM_COL32(0, 200, 25, alpha)
#define DEEPSKYBLUE(alpha)   IM_COL32(0, 191, 25, alpha)
#define SKYBLUE(alpha)       IM_COL32(0, 122, 204, alpha)

#define YELLOW(alpha)        IM_COL32(100, 100, 0, alpha)
#define ORANGE(alpha)        IM_COL32(100, 65, 0, alpha)
